...
如果是单个作者的文献，应该写成：Kivshar\supercite {babuDesignImplementationTwoWheeled2016}研究了...，得到了...结果。

如果是多个作者的文献，应该写成：Knight等\supercite{desouzaComparisonExperimentalPID2016}研究了...，得到了...结果。
姚建铨等\supercite{hejunhuZiPingHengCheKongZhiFangFaYanJiuJiFangZhenFenXi2019}研究了...，得到了...结果。只需要列出第一个作者加上``等''字即可。中英文的文献是一样的标准，都是加上`` 等''字。
